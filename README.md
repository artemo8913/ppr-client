...
5. Нередактируемые ячейки планов/фактов объемов и чел.-ч в низ строки
6. Только один месяц может быть в редактируемом статусе.
7. Добавить возможность делать "none" статус, чтобы можно было избежать редактирования нескольких месяцов
8. Перенести функции из meta useReactTable в usePprTableData
9. Убрать повторяющиеся типы в IPpr schema (связанные с планами по времени людей и работ)
10. Экспорт в excel или же pdf без рамок и т.д. и т.п. для печать ЭУ-132, ЭУ-99 и рапортов
11. Данные о дирекциях/дистанциях/цехах нужно где-то хранить на сервере и получать по api

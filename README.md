...
12. Хорошенько обдумать статус ППРа "plan_on_correction". Сейчас это просто промежуточное звено, обозначающее, что ППР отклонили. Можно же сразу отклонить ППР и использовать для этого статуса иное понятие. Как раз таки для корректировки, для изменения.
13. Закрепить временные периоды сверху при скролле
14. Строка с чел.-ч в ППРе на самом верху для удобства планирования и расставления чел.-ч
15. Копка скопировать данные в столбец "фактические трудозатраты" из столбца "трудозатраты согласно норме времени"
16. Проверка введенных данных в целом по ППРу
17. Если настой часов запланированных работ больше или меньше на 1, чем имеющийся настой часов, то закрасить цифру с суммарными запланированными человеко-часами
18. Нередактируемые ячейки планов/фактов объемов и чел.-ч в низ строки
19. Только один месяц может быть в редактируемом статусе.
20. Добавить возможность делать "none" статус, чтобы можно было избежать редактирования нескольких месяцов
21. Перенести функции из meta useReactTable в usePprTableData
22. Убрать повторяющиеся типы в IPpr schema (связанные с планами по времени людей и работ)
23. Экспорт в excel или же pdf без рамок и т.д. и т.п. для печать ЭУ-132, ЭУ-99 и рапортов

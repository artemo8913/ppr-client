...
import { PprField, IPlanWorkValues, IPprData } from "@/2entities/ppr";
...
export function calculateMonthRaport(allPprData: IPprData[], currentTimePeriod: Month) {
  const planField = PprField.getPlanWorkFieldByTimePeriod(currentTimePeriod);
  const factField = PprField.getFactWorkFieldByTimePeriod(currentTimePeriod);

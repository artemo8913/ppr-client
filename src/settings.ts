...
const settings: any = {
  ...
  pprColumnSettings: {
    ...
    entryYear: { title: "Год ввода в эксплуатацию", widthPercent: 1, titleRowSpan: 4, vText: true },
    periodicityNormal: {
    ...
    lastMaintenanceYear: { title: "Периодичность выполнения работ (факт)", widthPercent: 1, titleRowSpan: 4, vText: true },
    periodicityLast: {
    ...
    normOfTimeDocument: { title: "Обоснование нормы времени", widthPercent: 2, titleRowSpan: 4 },

...
const settings: any = {
  ...
  pprColumnSettings: {
    ...
    line_class: { title: "Класс участка / вид технического обслуживания и ремонта", widthPercent: 1, titleRowSpan: 4, vText: true },
    ...
    last_maintenance_year: { title: "Периодичность выполнения работ (факт)", widthPercent: 1, titleRowSpan: 4, vText: true },
    periodicity_fact: {
